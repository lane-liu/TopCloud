...
function searchBox() {
    ...
    '        <input type="text" autocomplete="off" name="wd" id="search-wd" placeholder="搜索歌名、歌手、专辑" autofocus required>' +
    '        <button class="search-submit" type="submit">搜 索</button>' + 
    '    </div>' + 
    '    <div class="radio-group" id="music-source">' + 
    '       <label><input type="radio" name="source" value="tencent" checked=""> QQ</label>' +
    '       <label><input type="radio" name="source" value="netease"> 网易云</label>' +
